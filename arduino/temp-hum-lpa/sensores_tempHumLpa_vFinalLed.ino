...
String BASE_URL = "https://tele-metry.net";
...
String sendDataToServer(String path)
{
  ...
  clientSecure.setFingerprint("49 38 0F CC 31 75 06 B3 E8 06 7A 65 6A 81 A2 81 AA 84 7D 3E");
...
String serializeComplex()
{
  ...
  float analog = 0;
   while(numAverage > 0) { 
     ...
     analog = analog + analogRead(sensorPin)* 0.09765625;
